...
public class AddPetPage {
    ...
    public AddPetPage(HtmlPage page) {
        ...
        assertTrue(containsLabelWithText(page, "Owner"));
        assertTrue(containsLabelWithText(page, "Name"));
        assertTrue(containsLabelWithText(page, "Birth Date"));
        assertTrue(containsLabelWithText(page, "Type"));
