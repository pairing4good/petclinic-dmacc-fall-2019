...
public class OwnerInfromationPage {
    ...
    public AddVisitPage addNewVisit(int petId) throws IOException {
        HtmlAnchor addVisit = (HtmlAnchor) page.getElementById("add-visit-link-" + petId);
        return new AddVisitPage(addVisit.click());
    }

    public VisitInformationSection visit(int visitId) {
        return new VisitInformationSection(visitId, page);
    }
}
